...
import config
import json
from root.modulosDEVS.DEVSGenerator import *
from root.modulosDEVS.CellDEVSGenerator import CellDEVSGenerator
from root.modulosCDPP.cdpp_model import CdppModel
from root.modulosCDPP.cdpp_model_to_ma_file import CdppModelToMaConverter
from root.modulosCDPP.preprocessing import preprocessing_devsml_for_ma
from root.modulosAuxiliares.valfile_generator import valfile_generator

from root.modulosAuxiliares.cell_devs_atomic.cell_devs_atomic_generator import cell_devs_atomic_generator


class Traductor:

    def __init__(self, archivo_modelos_base, log='logs/traductor.log'):
    ...
    def run_devs(self, devs_generator, hcpp_generator):
        ...
        for model, params in self.params_traducciones.items():
            ...
            shutil.copyfile('root/templates/Makefile', DEVSML_CPP_H_DIRECTORY + '/Makefile')
            shutil.copyfile('root/templates/macros.inc', DEVSML_CPP_H_DIRECTORY + '/macros.inc')
            shutil.copyfile('root/templates/tuple_to_real.h', DEVSML_CPP_H_DIRECTORY + '/tuple_to_real.h')
            shutil.copyfile('root/templates/tuple_to_real.cpp', DEVSML_CPP_H_DIRECTORY + '/tuple_to_real.cpp')
            shutil.copyfile('root/templates/equation_calculator.h', DEVSML_CPP_H_DIRECTORY + '/equation_calculator.h')
            shutil.copyfile('root/templates/equation_calculator.cpp', DEVSML_CPP_H_DIRECTORY + '/equation_calculator.cpp')
    ...
    def run_cell_devs(self, devs_generator, hcpp_generator):
        ...
        for model, params in self.params_traducciones.items():
            ...
            try:
                ...
                os.makedirs(DEVSML_CPP_H_DIRECTORY)
            # Initialize directory
            shutil.copyfile('root/templates/macros.inc', DIR + '/macros.inc')
            shutil.copyfile('root/templates/Makefile', DEVSML_CPP_H_DIRECTORY + '/Makefile')
