from root.modulosAuxiliares.cell_devs_atomic.cell_devs_opinion import cell_devs_opinion
from root.modulosAuxiliares.cell_devs_atomic.cell_devs_trafico import cell_devs_trafico
